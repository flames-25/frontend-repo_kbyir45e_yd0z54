        ...
        <div className="grid md:grid-cols-2 gap-8 mt-10">
          <div className="bg-white/80 backdrop-blur rounded-3xl p-6 shadow border border-white">
            ...
            <ul className="mt-4 space-y-3 text-pink-900/80">
              <li className="flex items-center gap-3"><Phone className="w-5 h-5 text-pink-600" /> +91 98765 43210</li>
              <li className="flex items-center gap-3"><Mail className="w-5 h-5 text-pink-600" /> hello@5staricream.com</li>
